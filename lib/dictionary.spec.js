...
describe("the dictionary", function() {
  ...
  describe("loading the dictionary file into the database", function() {
    it("loads the file into an array in memory, and then calls append", function() {
      // stub the actual appending, as it will take forever.
  ...
  describe("checking to see if words are anagrams", function() {
    it("returns true if all the words are anagrams of each other", function() {
      var results = dictionary.areAnagrams(['read', 'dear', 'dare']);
      expect(results).to.eql(true);
    });

    it("returns false if any of the words are not anagrams", function() {
      var results = dictionary.areAnagrams(['read', 'dear', 'snuffleuffagus']);
